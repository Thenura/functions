...
import { analytics, output, port, system, session } from '@shopify/cli-kit';
...
async function dev(options) {
    ...
    if (options.app.extensions.ui.length > 0) {
        const devExt = await devUIExtensionsTarget(options.app, apiKey, proxyUrl, storeFqdn, app.grantedScopes, options.subscriptionProductUrl, options.checkoutCartUrl);
